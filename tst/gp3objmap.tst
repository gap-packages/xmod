...
gap> ltconj := Left2DimensionalGroup( XSconj );; 
gap> dnconj := Down2DimensionalGroup( XSconj );; 
gap> rtconj := Right2DimensionalGroup( XSconj );; 
gap> up := XModMorphismByGroupHomomorphisms( upconj, upconj, idc5d, ad10b );
[[c5d->d10b] => [c5d->d10b]]
gap> left := XModMorphismByGroupHomomorphisms( ltconj, ltconj, idc5d, ad10a );
[[c5d->d10a] => [c5d->d10a]]
gap> down := XModMorphismByGroupHomomorphisms( dnconj, dnconj, ad10a, ad20 );
[[d10a->d20] => [d10a->d20]]
gap> right := XModMorphismByGroupHomomorphisms( rtconj, rtconj, ad10b, ad20 );
[[d10b->d20] => [d10b->d20]]
